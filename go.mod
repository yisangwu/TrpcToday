module trpc.app.HelloService

go 1.18

replace github.com/trpcproto/trpchello => ./stub/github.com/trpcproto/trpchello

require (
	github.com/trpcproto/trpchello v0.0.0-00010101000000-000000000000
